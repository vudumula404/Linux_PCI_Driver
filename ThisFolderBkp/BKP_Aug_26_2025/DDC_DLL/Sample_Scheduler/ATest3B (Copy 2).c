...
void main()
{
	...
	int Large=0,MessageNum=1,smal=0,a=1,b=20,rev=0,Present=0,Num=0,rtAddr=0,rtModId=2;
        fd_set set;
	...
	if(InitCard(CARD1))
	{
		...
		while(!kbhit()) 
		{
			...
			case 2:
			        enableNonCanonicalMode();
				printf("\n\t 2.BC mode with updated scheduler \n");
				InitCard_init();
				//Init_RT();				
				//usleep(100);
				//Init_MT(); usleep(100);
