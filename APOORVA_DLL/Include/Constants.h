...
#define CONFIG_REG3  0x3 /* read/write */
#define CONFIG_REG4  0x4 /* read/write */
...
#define INTR_TMR1	0x2020		//use for enable/disable RTC1 interrupt
#define INTR_TMR2	0x4040		//use for enable/disable RTC2 interrupt
#define INTR_TMR3	0x8080		//use for enable/disable RTC3 interrupt
...
#define INTR_MT_DATASTACK_ROLL_OVER	4  //use for enable/disable MT_DATASTK_ROLL_OVER interrupt
#define INTR_MT_CMDSTACK_ROLL_OVER	8  //use for enable/disable MT_CMDSTK_ROLL_OVER interrupt
