...
FILE* logFile = NULL;
void UpdateMsgData1(UCHAR ModId, unsigned short msg_num, unsigned short *new_data, int num_words, int direction)
{
...
void BCSchedule_Bus()
{
    ...
    unsigned short inter_msg_gap=10,msg_no=0,idx=0,module_id=1,data_value=0;
    double dftDuration = 0.0;
    int prevPos = 0;  
    printf("Bus thread Start...\n");
	 for(MC_minor_cycle_number=0;MC_minor_cycle_number<2;MC_minor_cycle_number++)
	 {	  
	    ...
	    switch(MC_minor_cycle_number)
	        ...
	        /* ================= FRAME 0 ================= */
                for (msg_no = 1; msg_no <= 41; msg_no++)
                {
                    ...
                    /* Fill message data buffer */
                    for (idx = 0; idx < bc_page.cmd_1.wcnt; idx++)
                        data_buffer[idx] = ++data_value;

                    DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                    //printf("MC_0:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
                }
                break;
              case 1 :
                ...
                for (msg_no = 1; msg_no <= 10; msg_no++)
                {
                    ...
                    switch (msg_no)
                    {
                        ...
                        case 31:
                            bc_page.rt_rt = YES;
                            bc_page.cmd_1.taddr = 13; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.subaddr = 13; bc_page.cmd_1.wcnt = 24;
                            bc_page.cmd_2.taddr = 15; bc_page.cmd_2.t_r = RECEIVE; bc_page.cmd_2.subaddr = 3;  bc_page.cmd_2.wcnt = 24;
                            break;
                    ...
                    DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                    //printf("MC_1:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
                }
	       break;
              case 2 :
	             /* ================= FRAME 2 ================= */
              for (msg_no = 1; msg_no <= 43; msg_no++)
              {
                  ...
                  switch (msg_no)
                  {
                      ...
                      case 42: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 5;  bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 43: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 11; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                  ...
                  DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                 // printf("MC_2:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
              }
              ...
              case 3 :
                ...
                for (msg_no = 1; msg_no <= 44; msg_no++)
                {
                    ...
                    switch (msg_no)
                    {
                        ...
                        case 43: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 21; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                        case 44: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 22; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                    ...
                    DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                    //printf("MC_3:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
                }
	              break;  
              case 4 :
	             /* ================= FRAME 4 ================= */
              for (msg_no = 1; msg_no <= 46; msg_no++)
              {
                  ...
                  switch (msg_no)
                  {
                      ...
                      case 45: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 16; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 46: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 14; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                  ...
                  DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                  //printf("MC_4:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
              }
              ...
              for (msg_no = 1; msg_no <= 45; msg_no++)
              {
                 ++MsCoun;
                  ...
                  switch (msg_no)
                  {
                      ...
                      case 19: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 15; bc_page.cmd_1.subaddr = 5; bc_page.cmd_1.wcnt = 4; break;
                      case 20: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 15; bc_page.cmd_1.subaddr = 8; bc_page.cmd_1.wcnt = 32; break;
                      ...
                      case 27: bc_page.cmd_1.taddr = 7;  bc_page.cmd_1.subaddr = 1;  bc_page.cmd_1.wcnt = 17; bc_page.cmd_1.t_r = RECEIVE; break;
                      case 28: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.subaddr = 13; bc_page.cmd_1.wcnt = 24; break;
                      ...
                      case 44: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 25; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 45: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 26; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                  ...
                  DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                 // printf("MC_5:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
              }
	             break;				
              case 6 :
	              /* ================= FRAME 6 ================= */
              for (msg_no = 1; msg_no <= 48; msg_no++)
              {
                 ++MsCoun;
                  ...
                  switch(msg_no)
                  {
                      ...
                      case 13: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.subaddr = 15; bc_page.cmd_1.wcnt = 25; break;
                      ...
                      case 22: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 15; bc_page.cmd_1.subaddr = 6;  bc_page.cmd_1.wcnt = 19; break;
                      ...
                      case 47: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 48: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.subaddr = 0;bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                  ...
                  DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                 // printf("MC_6:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
              }
	      break;	
              case 7 :
	              /* ================= FRAME 7 ================= */
              for (msg_no = 1; msg_no <= 48; msg_no++)
              {
                  ...
                  switch(msg_no)
                  {
                      ...
                      case 36: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 21; bc_page.cmd_1.subaddr = 2; bc_page.cmd_1.wcnt = 13; break;
                      case 37: bc_page.rt_rt = YES; bc_page.cmd_1.taddr = 22; bc_page.cmd_1.subaddr = 2; bc_page.cmd_1.wcnt = 13; break;
                  ...
                  DefMsg1553(module_id, MsCoun, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                  //printf("MC_7:module_id %d MsCoun %d bc_page.cmd_1.wcnt %d inter_msg_gap %d\n",module_id,MsCoun,bc_page.cmd_1.wcnt,inter_msg_gap);
              }
          ...
          /*for (minor_cycle_index = 0; minor_cycle_index < minor_cycle_count; minor_cycle_index++)
            {
                ...
                int start = MC_minor_cycle_number * msg_count;
                int end = start + msg_count;
                for (idx = start; idx < end; idx++)
                {
                    major_frames[MC_minor_cycle_number].frame_items[idx-start] = idx + 1;
                     printf("MC[%d]idx[%d]: MsgCount=%d start[%d] end[%d]\n",MC_minor_cycle_number,
                       idx,
                       msg_count,
                       start,end);
                }
	...
	DefMajorFrame(1, 0, 2, major_frames);
        //PriorityHighLow(module_id, 2, 1);
        printf("BC Major Frame Started Wait........! \n");
        RunBcMajorFrame(1, 0,2, major_frames, 1);
        getchar();
