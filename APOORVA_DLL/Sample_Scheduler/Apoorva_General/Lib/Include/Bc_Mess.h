...
Abstract:
    ...
    Defines Bus Controller Structures.	
...
typedef struct {
       ...
       unsigned short  bsw;       /* block status word   */
       unsigned short  time_tag;  /* time tag            */
       unsigned short  cntrl_word;/* control word        */
       unsigned short  cmd_1;     /* command word 1      */
       unsigned short  cmd_2;     /* command word 2      */
       unsigned short  status_1 ; /* status word 1       */
       unsigned short  status_2 ; /* status word 2       */
       unsigned short  loop_word;/* loop back word       */
       unsigned short  data[32]; /* 32 data words max i.e. 0-31 */
       } MSG_RESULT;
