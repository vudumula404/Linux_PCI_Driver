...
#define INTR_INTERNALTMR1			0x0  //use for enable/disable RTC1 interrupt
#define INTR_EXTERNALTMR1			0x1  //use for enable/disable RTC2 interrupt

#define INTR_INTERNALTMR2			0x0  //use for enable/disable RTC1 interrupt
#define INTR_EXTERNALTMR2			0x2  //use for enable/disable RTC2 interrupt
...
#define TIMER1							0  //use for enable/disable External interrupt
#define TIMER2							1  //use for enable/disable External interrupt
