...
//EXP BOOL InitRS422(UCHAR chan,unsigned int baud);
...
EXP	CHAR	InitTimerIntr(UCHAR Value,UCHAR InEx,UCHAR CardId);
EXP CHAR	InitExternalInterrupts(UCHAR,UCHAR val,UCHAR);
EXP CHAR	StopTimerIntr(UCHAR Value,UCHAR CardId);
EXP CHAR	SelectTMR(unsigned long Value,UCHAR timer,UCHAR CardId);
