...
void main()
{
	...
	DefMsg(2,BCSTACK_A,1,bc_page,data_buffer,32,CARD1);


	
	frame_items[0] = 1;
	DefFrame(2,BCSTACK_A,1,frame_items,CARD1);
	
	
	RunBc(2,BCSTACK_A,1,1,1,CARD1);		
	
	getchar();
		ret=ReadMsgBC(2,BCSTACK_A,1,&msg_return,CARD1);
