...
void BCSchedule_Bus()
{
	        ...
	        /* ================= FRAME 0 ================= */
                for (msg_no = 1; msg_no <= 43; msg_no++)
                {
                    ...
                    switch (msg_no)
                    {
                        ...
                        /* ---- Mode Codes ---- */
                        case 40: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 15; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                        case 41: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 15; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                    ...
                    DefMsg1553(module_id, msg_no, bc_page, data_buffer, bc_page.cmd_1.wcnt, inter_msg_gap);
                }
                break;
              case 1 :
	             /* ==================== FRAME 1 MESSAGE DEFINITION ==================== */
                for (msg_no = 1; msg_no <= 51; msg_no++)
                {
                    memset(&bc_page, 0, sizeof(bc_page));
                    bc_page.self_test = NO;
                    bc_page.mask_bcst_bit = NO;
	       ...
	       break;
              ...
              for (msg_no = 1; msg_no <= 46; msg_no++)
              {
                  ...
                  switch (msg_no)
                  {
                      ...
                      /* ---- Mode Codes ---- */
                      case 40: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 5;  bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 41: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 11; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 42: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 5;  bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 43: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 11; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
              ...
              case 3 :
                ...
                for (msg_no = 1; msg_no <= 47; msg_no++)
                {
                    ...
                    switch (msg_no)
                    {
                        ...
                        /* ---- Mode Codes ---- */
                        case 41: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 21; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                        case 42: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 22; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                        case 43: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 21; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                        case 44: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 22; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
              ...
              for (msg_no = 1; msg_no <= 49; msg_no++)
              {
                  ...
                  switch (msg_no)
                  {
                      ...
                      /* ---- Mode Codes ---- */
                      case 43: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 16; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 44: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 14; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 45: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 16; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 46: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 14; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
              ...
              for (msg_no = 1; msg_no <= 48; msg_no++)
              {
                  ...
                  switch (msg_no)
                  {
                      ...
                      case 42: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 25; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 43: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 26; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 44: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 25; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 45: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 26; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
              ...
              for (msg_no = 1; msg_no <= 51; msg_no++)
              {
                  ...
                  switch(msg_no)
                  {
                      ...
                      case 45: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 46: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 10; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 47: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 48: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 13; bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
	      ...
	      break;	
              ...
              for (msg_no = 1; msg_no <= 51; msg_no++)
              {
                  ...
                  switch(msg_no)
                  {
                      ...
                      /* Mode Codes */
                      case 47: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 7;  bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
                      case 48: bc_page.mode_code = YES; bc_page.cmd_1.taddr = 7;  bc_page.cmd_1.t_r = TRANSMIT; bc_page.cmd_1.wcnt = 0; break;
	...
	DefMajorFrame(1, 0, 8, major_frames);
        ...
        RunBcMajorFrame(1, 0, 8, major_frames, 1000);
        getchar();
