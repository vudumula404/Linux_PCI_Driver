...
void fnExtractMessagesB2(char * szFilename)
{
	...
	while (!feof(fpstConfigFile))
	{
		...
		if(iRet == 3)
		{
			...
			ubyChannelSel		= fnGetChannelSel(m_ubyMessageNumber);
			ubyWordCount		= fnGetWordCount(m_ubyMessageNumber);
			fnGetMessageName(m_ubyMessageNumber,m_stMsg[1][m_ubyMessageNumber].szMessageName);
		...
		/*	if(ubySourceAddress<32)
			...
			*/
			m_stMsg[1][m_ubyMessageNumber].MsgDef.Int_Msg_Gap	 = 10;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.bus           = ubyChannelSel; 
			m_stMsg[1][m_ubyMessageNumber].MsgDef.self_test     = NO;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.retry_enable = YES;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.mask_bcst_bit = NO;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.broadcast     = NO;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.mode_code     = NO;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.rt_rt         = NO;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.taddr   = ubyDestAddress;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.status  = 0xcccc;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.loop          = 0x0000;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.subaddr = ubyDestSubAddress;
			m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.wcnt    = ubyWordCount; 

			if(ubySourceAddress == 32)/* BC->RT transfer */
			{
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.t_r			= RECEIVE;
				m_stMsg[1][m_ubyMessageNumber].ubyRxMsgCount = ubyReceiveMessageCount;
				ubyReceiveMessageCount++;
			}
			if(ubyDestAddress == 32)/* RT->BC transfer */
			{
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.t_r	 = TRANSMIT;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.taddr   = ubySourceAddress;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.subaddr = ubySourceSubAddress;
				m_stMsg[1][m_ubyMessageNumber].ubyTxMsgCount = ubyTransmitMessageCount;
				ubyTransmitMessageCount++;
			}
			if(( (ubyDestSubAddress == 0) || (ubyDestSubAddress == 31)) && ubySourceAddress == 32)/* Mode code *//* Source is BC.*/
			{
				m_stMsg[1][m_ubyMessageNumber].MsgDef.mode_code     = YES;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.t_r	 = TRANSMIT;
			}
			if(( (ubySourceSubAddress == 0) || (ubySourceSubAddress == 31)) && (ubyDestAddress == 32))/* Mode code *//* Source is RT.*/
			{
			...
			if((ubySourceAddress != 32) && (ubyDestAddress != 32))/* RT to RT transfer */
			{
				m_stMsg[1][m_ubyMessageNumber].MsgDef.rt_rt         = YES;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.taddr   = ubySourceAddress;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.status  = 0xcccc;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.subaddr = ubySourceSubAddress;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.wcnt    = ubyWordCount;  
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_1.t_r	 = TRANSMIT;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_2.taddr   = ubyDestAddress;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_2.status  = 0xcccc;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_2.subaddr = ubyDestSubAddress;
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_2.wcnt    = ubyWordCount; 
				m_stMsg[1][m_ubyMessageNumber].MsgDef.cmd_2.t_r	 = RECEIVE;
			}
...
void fnExtractMessagesB3(char * szFilename)
{
	...
	while (!feof(fpstConfigFile))
	{
		...
		if(iRet == 3)
		{
			...
			ubyChannelSel		= fnGetChannelSel(m_ubyMessageNumber);
			ubyWordCount		= fnGetWordCount(m_ubyMessageNumber);
			fnGetMessageName(m_ubyMessageNumber,m_stMsg[2][m_ubyMessageNumber].szMessageName);
		...
		/*	if(ubySourceAddress<32)
			...
			*/
			m_stMsg[2][m_ubyMessageNumber].MsgDef.Int_Msg_Gap	 = 10;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.bus           = ubyChannelSel; 
			m_stMsg[2][m_ubyMessageNumber].MsgDef.self_test     = NO;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.retry_enable = YES;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.mask_bcst_bit = NO;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.broadcast     = NO;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.mode_code     = NO;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.rt_rt         = NO;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.taddr   = ubyDestAddress;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.status  = 0xcccc;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.loop          = 0x0000;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.subaddr = ubyDestSubAddress;
			m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.wcnt    = ubyWordCount; 

			if(ubySourceAddress == 32)/* BC->RT transfer */
			{
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.t_r			= RECEIVE;
				m_stMsg[2][m_ubyMessageNumber].ubyRxMsgCount = ubyReceiveMessageCount;
				ubyReceiveMessageCount++;
			}
			if(ubyDestAddress == 32)/* RT->BC transfer */
			{
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.t_r	 = TRANSMIT;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.taddr   = ubySourceAddress;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.subaddr = ubySourceSubAddress;
				m_stMsg[2][m_ubyMessageNumber].ubyTxMsgCount = ubyTransmitMessageCount;
				ubyTransmitMessageCount++;
			}
			if(( (ubyDestSubAddress == 0) || (ubyDestSubAddress == 31)) && ubySourceAddress == 32)/* Mode code *//* Source is BC.*/
			{
				m_stMsg[2][m_ubyMessageNumber].MsgDef.mode_code     = YES;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.t_r	 = TRANSMIT;
			}
			if(( (ubySourceSubAddress == 0) || (ubySourceSubAddress == 31)) && (ubyDestAddress == 32))/* Mode code *//* Source is RT.*/
			{
			...
			if((ubySourceAddress != 32) && (ubyDestAddress != 32))/* RT to RT transfer */
			{
				m_stMsg[2][m_ubyMessageNumber].MsgDef.rt_rt         = YES;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.taddr   = ubySourceAddress;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.status  = 0xcccc;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.subaddr = ubySourceSubAddress;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.wcnt    = ubyWordCount;  
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_1.t_r	 = TRANSMIT;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_2.taddr   = ubyDestAddress;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_2.status  = 0xcccc;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_2.subaddr = ubyDestSubAddress;
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_2.wcnt    = ubyWordCount; 
				m_stMsg[2][m_ubyMessageNumber].MsgDef.cmd_2.t_r	 = RECEIVE;
			}
...
{   
	...
	for (int wMinorFrameIndex = MINOR_CYCLE_ZERO; wMinorFrameIndex <=MINOR_CYCLE_SEVEN; wMinorFrameIndex++)
	{
			...
			if (wMinorFrameIndex == MINOR_CYCLE_ZERO)
			{
				...
				{
					uwMessCount2 = m_MinorFrame[wMinorFrameIndex].Mess_Count;
					memset(uhwFrameItems,0,sizeof(uhwFrameItems));
				...
				{
					uwMessCount3 = m_MinorFrame[wMinorFrameIndex].Mess_Count;
					memset(uhwFrameItems,0,sizeof(uhwFrameItems));
